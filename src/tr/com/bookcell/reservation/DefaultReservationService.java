...
public class DefaultReservationService implements ReservationService {
    ...
    @Override
    public void remove(String customerEmail, String bookName, String authorName, String authorSurname, String startDate) {
        LocalDate formattedStartDate = dateFormatter(startDate);
        if (formattedStartDate == null) {
            ...
            String formattedAuthorName = capitalizeForMultipleStrings(authorName);
            String formattedAuthorSurname = capitalizeFirst(authorSurname);
            Reservation reservation = getByStartDate(customerEmail, formattedBookName, formattedAuthorName, formattedAuthorSurname, startDate);
            if (reservation == null) {
    ...
    @Override
    public void setStartDate(String customerEmail, String bookName, String authorName, String authorSurname, String newStartDate, String deliveryDate) {
        ...
        if (formattedStartDate == null || formattedDeliveryDate == null) {
            ...
            String formattedAuthorName = capitalizeForMultipleStrings(authorName);
            String formattedAuthorSurname = capitalizeFirst(authorSurname);
            Reservation reservation = getByDeliveryDate(customerEmail, formattedBookName, formattedAuthorName, formattedAuthorSurname, deliveryDate);
            if (reservation == null) {
                System.out.println("THERE IS NO RESERVATION MADE FOR " + formattedBookName + " IN THIS CUSTOMER'S RESERVATION LIST.");
    ...
    @Override
    public void setDeliveryDate(String customerEmail, String bookName, String authorName, String authorSurname, String startDate, String newDeliveryDate) {
