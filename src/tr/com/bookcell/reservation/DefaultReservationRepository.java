...
public class DefaultReservationRepository implements ReservationRepository {
    ...
    private static final String DELETE_RESERVATIONS = "DELETE FROM public.\"RESERVATION\" WHERE \"CUSTOMER_ID\" = ? AND \"BOOK_ID\" = ? AND \"START_DATE\"=?;";
    ...
    @Override
    public void remove(Integer customerId, Integer bookId, LocalDate startDate) {
        try (Connection connection = connect()) {
